...
//  OPTION(options, smooth_j_x, true); 
...
//      Jpar=nl_filter(Jpar,filter_para);
//      Vort=nl_filter(Vort,filter_para);
//      psi=nl_filter(psi,filter_para);
//      phi=nl_filter(phi,filter_para);
    }
...
ddt(psi) = -Jpara0*Grad_par(phi)/B0 - eta*Jpar;
